...
class AmazonMerchantShipmentCreator extends AmazonMerchantCore {
    ...
    public function fetchServices() {
        $services = new AmazonMerchantServiceList($this->configuration, $this->storeName, $this->mockMode, $this->mockFiles);
    ...
    protected function parseXML($xml){
        ...
        $this->shipment = new AmazonMerchantShipment($this->configuration, $this->storeName, NULL, $xml, $this->mockMode, $this->mockFiles);
