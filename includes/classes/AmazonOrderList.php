...
class AmazonOrderList extends AmazonOrderCore implements Iterator{
    ...
    public function resetMarketplaceFilter(){
        ...
        if(strlen($this->configuration->getMarketplaceId()) > 0) {
            $this->options['MarketplaceId.Id.1'] = $this->configuration->getMarketplaceId();
        } else {
    ...
    protected function parseXML($xml){
        ...
        foreach($xml->Orders->children() as $key => $data){
            ...
            $this->orderList[$this->index] = new AmazonOrder($this->configuration, $this->storeName,null,$data,$this->mockMode,$this->mockFiles);
