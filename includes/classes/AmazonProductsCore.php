...
abstract class AmazonProductsCore extends AmazonCore{
    ...
    public function __construct(AmazonConfigurationInterface $configuration = null, $s = null, $mock = false, $m = null){
        ...
        if(strlen($this->configuration->getMarketplaceId()) > 0){
            $this->setMarketplace($this->configuration->getMarketplaceId());
        } else {
        ...
        foreach($xml->children() as $x){
            ...
            if (isset($x->Products)){
                foreach($x->Products->children() as $z){
                    $this->productList[$this->index] = new AmazonProduct($this->configuration, $this->storeName, $z, $this->mockMode, $this->mockFiles);
                ...
                $this->productList[$this->index] = new AmazonProduct($this->configuration,$this->storeName, $x, $this->mockMode, $this->mockFiles);
                $this->index++;
            } else {
