...
abstract class AmazonCore
{
     ...
     */
    protected function __construct(AmazonConfigurationInterface $configuration = null, $s = null, $mock = false, $m = null)
    {

        if (!$configuration instanceof AmazonConfigurationInterface) {
            throw new Exception('Amazon MWS invalid configuration.');
        }

        $this->configuration = $configuration;
        $this->urlbase = rtrim($this->configuration->getServiceUrl(), '/') . '/';
...
<ErrorResponse xmlns="http://mws.amazonaws.com/doc/2009-01-01/">
  ...
  <RequestID>123</RequestID>
     ...
     * @param bool|int|string $time [optional] <p>The time to use. Since any string values are
    ...
    protected function genQuery()
    {
        ...
        if (strlen($this->configuration->getSecretKey()) === 0) {
