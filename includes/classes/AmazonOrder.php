...
class AmazonOrder extends AmazonOrderCore{
     ...
     */
    public function __construct(AmazonConfigurationInterface $configuration = null, $s = null, $id = null, $data = null, $mock = false, $m = null){
    ...
    public function fetchItems($token = false){
        ...
        $items = new AmazonOrderItemList($this->configuration, $this->storeName,$this->data['AmazonOrderId'],$this->mockMode,$this->mockFiles);
