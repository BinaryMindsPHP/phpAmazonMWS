...
class AmazonOrderSet extends AmazonOrderCore implements Iterator{
     ...
     */
    public function __construct(AmazonConfigurationInterface $configuration = null, $s = null, $o = null, $mock = false, $m = null){
    ...
    protected function parseXML($xml){
        ...
        foreach($xml->Orders->children() as $key => $order){
            ...
            $this->orderList[$this->index] = new AmazonOrder($this->configuration, $this->storeName,null,$order,$this->mockMode,$this->mockFiles);
